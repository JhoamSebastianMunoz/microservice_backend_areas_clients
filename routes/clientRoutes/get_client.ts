...
router.get('/:id_cliente', verifyToken, checkRoleAndPermission(["ADMINISTRADOR","COLABORADOR"]), getClientValidator.validatorParams, getClientValidator.validator, getClientController);
